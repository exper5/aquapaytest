...
@Component({
  selector: 'app-aslastpayment',
  templateUrl: './aslastpayment.component.html',
  styleUrls: ['./aslastpayment.component.css']
})
export class AslastpaymentComponent implements OnInit {
