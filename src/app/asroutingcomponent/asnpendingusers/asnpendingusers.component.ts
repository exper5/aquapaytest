...
declare var $ :any;
@Component({
  selector: 'app-asnpendingusers',
  templateUrl: './asnpendingusers.component.html',
  styleUrls: ['./asnpendingusers.component.css']
})
export class AsnpendingusersComponent implements OnInit {
