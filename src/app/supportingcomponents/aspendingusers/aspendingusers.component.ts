...
declare var $ :any;
@Component({
  selector: 'app-aspendingusers',
  templateUrl: './aspendingusers.component.html',
  styleUrls: ['./aspendingusers.component.css']
})
export class AspendingusersComponent implements OnInit {
