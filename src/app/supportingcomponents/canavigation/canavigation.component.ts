...
declare var $ :any;
@Component({
  selector: 'app-canavigation',
  templateUrl: './canavigation.component.html',
  styleUrls: ['./canavigation.component.css']
})
export class CanavigationComponent implements OnInit {
