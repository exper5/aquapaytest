...
declare var $ :any;
@Component({
  selector: 'app-asuserslistreport',
  templateUrl: './asuserslistreport.component.html',
  styleUrls: ['./asuserslistreport.component.css']
})
export class AsuserslistreportComponent implements OnInit {
