...
declare var $ :any;
@Component({
  selector: 'app-careviewusers',
  templateUrl: './careviewusers.component.html',
  styleUrls: ['./careviewusers.component.css']
})
export class CareviewusersComponent implements OnInit {
