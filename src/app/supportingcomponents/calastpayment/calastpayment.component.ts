...
declare var $ :any;
@Component({
  selector: 'app-calastpayment',
  templateUrl: './calastpayment.component.html',
  styleUrls: ['./calastpayment.component.css']
})
export class CalastpaymentComponent implements OnInit {
