...
declare var $ :any;
@Component({
  selector: 'app-chpendingsupplier',
  templateUrl: './chpendingsupplier.component.html',
  styleUrls: ['./chpendingsupplier.component.css']
})
export class ChpendingsupplierComponent implements OnInit {
